...
export const RamCostConstants: IMap<number> = {
  ...
  ScriptSuppressRamCost: 1.9,
  ScriptGetServerSuppressionRamCost: 0.05,
  ScriptSuppressAnalyzeRamCost: 1,
...
export const RamCosts: IMap<any> = {
  ...
  suppress: RamCostConstants.ScriptSuppressRamCost,
  getServerSuppression: RamCostConstants.ScriptGetServerSuppressionRamCost,
  suppressAnalyze: RamCostConstants.ScriptSuppressAnalyzeRamCost,
  print: 0,
  printf: 0,
  tprint: 0,
  clearLog: 0,
